...
wget --no-check-certificate --content-disposition -c https://downloads.jboss.org/keycloak/7.0.1/keycloak-7.0.1.zip
curl -LO -k 'https://downloads.jboss.org/keycloak/7.0.1/keycloak-7.0.1.zip'
